...
public class PersonController {
	...
	public Iterable<PersonDto> findByAges(@PathVariable Integer minAge,
	...
	public Iterable<EmployeeDto> findEmployeesBySalary(
			@PathVariable int minSalary, @PathVariable int maxSalary) {
